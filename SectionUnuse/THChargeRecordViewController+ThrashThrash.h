...
#import "THChargeRecordViewController.h"
#import "THUserChargeModel.h"
#import "THMeTableViewCell.h"
#import "THCoinSectionModel.h"
#import "THChargeRecordViewController+Thrash.h"

@interface THChargeRecordViewController (ThrashThrash)
...
+ (BOOL)dealWithDataThrashThrash:(NSInteger)THRash;
+ (BOOL)addCoinImageToStringThrashThrash:(NSInteger)THRash;
+ (BOOL)createHeadViewWithSectionThrashThrash:(NSInteger)THRash;
+ (BOOL)topRefreshControlThrashThrash:(NSInteger)THRash;
+ (BOOL)loadUserChargeRecordDataCompleteThrashThrash:(NSInteger)THRash;
...
+ (BOOL)tableViewViewforheaderinsectionThrashThrash:(NSInteger)THRash;
...
+ (BOOL)tableViewHeightforheaderinsectionThrashThrash:(NSInteger)THRash;
