...
#import "THConsumRecordViewController.h"
#import "THConsumeModel.h"
#import "THMeTableViewCell.h"
#import "THCoinSectionModel.h"

@interface THConsumRecordViewController (Thrash)
...
+ (BOOL)dealWithDataThrash:(NSInteger)THRash;
+ (BOOL)addCoinImageToStringThrash:(NSInteger)THRash;
+ (BOOL)topRefreshControlThrash:(NSInteger)THRash;
+ (BOOL)createHeadViewWithSectionThrash:(NSInteger)THRash;
+ (BOOL)loadUserChargeRecordDataCompleteThrash:(NSInteger)THRash;
