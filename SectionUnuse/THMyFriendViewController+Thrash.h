...
#import "THMyFriendViewController.h"
#import "THFriendModel.h"
#import "THMeTableViewCell.h"

@interface THMyFriendViewController (Thrash)
...
+ (BOOL)headViewThrash:(NSInteger)THRash;
...
+ (BOOL)loadFriendRecordDataSuccessFailureThrash:(NSInteger)THRash;
