...
+ (void) launchProgress {
    ...
    if ([LEUserManager isUserLogin]) {
        config.fileURL = [[[config.fileURL URLByDeletingLastPathComponent]  URLByAppendingPathComponent:[NSString stringWithFormat:@"%@",[LEUserManager userId]]] URLByAppendingPathExtension:@"realm"];
    }
    else
    {
...
//            }
        ...
        if ([LEUserManager isUserLogin]) {
            realConfigure.fileURL = [[[initRealmRootPath URLByDeletingLastPathComponent]  URLByAppendingPathComponent:[NSString stringWithFormat:@"%@",[LEUserManager userId]]] URLByAppendingPathExtension:@"realm"];
        }
        else
        {
