...
{
        [ZWREventsManager sendViewControlleWithCallBackEvent:kEventTHChargeViewController parameters:@(YES) animated:YES callBack:^(id obj) {
            if (completeBlock) {
                completeBlock();
            }
        }];
}
//+(void)showLoginView:(void(^)(id obj)) completeBlock
//{
//    if([AYGlobleConfig shared].isNormalModel)
//    {
...
//    else
//    {
//        THLogiinViewController *loginView = [[THLogiinViewController alloc] init];
//        loginView.callBack =completeBlock;
//        loginView.view.frame = CGRectMake(0, -ScreenHeight, SCREEN_WIDTH, ScreenHeight);
//        UIView *maskView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight)];
//        maskView.backgroundColor = UIColorFromRGBA(0x000000, 0.5f);
//        maskView.alpha =0;
//        LEWeakSelf(catalogView)
//        [maskView addTapGesutureRecognizer:^(UITapGestureRecognizer *ges) {
//            [UIView animateWithDuration:0.5f animations:^{
//                LEStrongSelf(catalogView)
//                catalogView.view.alpha =0.1f;
//                ges.view.alpha = 0.1f;
//            } completion:^(BOOL finished) {
//                [catalogView.view removeFromSuperview];
//                [ges.view removeFromSuperview];
//            }];
//        }];
//        catalogView.view.alpha =0;
//        [[AYUtitle getAppDelegate].window addSubview:maskView];
//        [[AYUtitle getAppDelegate].window addSubview:catalogView.view];
//        [UIView animateWithDuration:0.5f animations:^{
//            catalogView.view.alpha =1;
//            maskView.alpha = 1;
//        }];
//    }
//}
